                            ...
                            u || (u = Z[l] = v('ON_PROPERTY' + l)),
                                (a.set = function(t) {
                                    ...
                                    n || e !== m || (n = m),
                                        n &&
                                            (n[u] &&
                                                n.removeEventListener(l, z),
                                            c && c.apply(n, _),
                                            'function' == typeof t
                                                ? ((n[u] = t),
                                                  n.addEventListener(l, z, !1))
                                                : (n[u] = null));
                                }),
                                (a.get = function() {
                                    var t = this;
                        ...
                        (a[n] = function() {
                            ...
                            I &&
                                ...
                                'function' ==
                                    ...
                                    Object.getOwnPropertySymbols(i).forEach(
                                        function(e) {
                                            var t = Object.getOwnPropertyDescriptor(
                                                i,
                                                e
                    ...
                    if (!E || D) {
                        ...
                        if (
                            ...
                            if (S) {
                                ...
                                de(
                                    f,
                                    he.concat(['messageerror']),
                                    u ? u.concat(p) : u,
                                    r(f)
                                ),
                                    de(Document.prototype, he, u),
                                    void 0 !== f.SVGElement &&
                                        de(f.SVGElement.prototype, he, u),
                            ...
                            (function(e, t) {
                                ...
                                for (
                                    var s = e.__Zone_disable_IE_check || !1,
                                        c =
                                            e.__Zone_enable_cross_context_check ||
                                            !1,
                                        l = F(),
                                        h =
                    ...
                    Zone.__load_patch('XHR', function(e, t) {
                        !(function(u) {
                            ...
                            function T(e) {
                                var t = e.data;
                                return (
                                    (t.aborted = !0), Z.apply(t.target, t.args)
                                );
                            }
